	...
	function getFolderPathHTML($folder, $tagAll=false, $document=null) { /* {{{ */
		...
		if($folder->getAccessMode($user) >= M_READWRITE) 
		{
            ...
            $txtpath .= "<li class=\"pull-right breadcrumb-btn\"><a href =\"".$ruta_generar_indice. "\" id=\"generar_indice\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".getMLText("generar_indice")."\"><i class=\"fa fa-share-square-o fa-4x\"></i> <br>Consolidar y generar índice</a></li>";
              ...
              $txtpath .= "<li class=\"pull-right breadcrumb-btn\"><a href =\"".$ruta_indice_desclasificacion. "\" id=\"indice_desclasificacion\" type=\"button\" class=\"btn bg-navy  btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".getMLText("indice_desclasificacion")."\"><i class=\"fa fa-gavel fa-4x\"></i> <br>Índice de desclasificación</a></li>";
...
if($user->isAdmin())
{
 ...
 $rutaLista="/out/out.ListaTerminados.php";
	 $txtpath .= "<li class=\"pull-right breadcrumb-btn\"><a href =\"".$rutaLista. "\" id=\"proximas\" type=\"button\" class=\"btn bg-black btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".getMLText("Ver qúe oficiales ya terminaron su índice")."\"><i class=\"fa fa-users fa-4x\"></i> <br>Oficiales que terminaron su índice</a> </a></li>";
			...
			if(!$user->isAdmin() && !$user->isGuest())//si es oficial (no es ni admin ni invitado) es que veo botones de subir docs
			{
				...
				//añadir reserva
				$txtpath .= "<li class=\"pull-right breadcrumb-btn\"><a id=\"add-document\" type=\"button\" class=\"btn bg-black btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".getMLText("add_document")."\"><i class=\"fa fa-plus fa-3x\"></i> <i class=\"fa fa-file-archive-o fa-4x\"></i><br>Añadir reserva</a></li>";
			}
