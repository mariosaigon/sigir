...
<!--  oculto "Resultado de lá búsqueda" pues es redundante, por defecto value=3 que equivale a both (Buscar en documentos y carpetas)-->
  ...
  <div class="box-body">
				...
				<?php
						if($attrdefs) {
							foreach($attrdefs as $attrdef) 
							{
								if(strcmp($attrdef->getName(), "Base constitucional")==0 ||  strcmp($attrdef->getName(), "Detalle de la reserva parcial")==0 ||  strcmp($attrdef->getName(), "Normativa nacional")==0 || strcmp($attrdef->getName(), "Reglamentos o instrumentos administrativos")==0 || strcmp($attrdef->getName(), "Tratados internacionales")==0 )
								{
									continue;
								}
								$attricon = '';
